<%-- 
    ...
    Created on : 23 de nov de 2019, 09:51:54
    Author     : Victor
--%>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Gerenciar Funcionario</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <form class="form-horizontal" id="formFunci">
                                    ...
                                    <div class="card shadow mb-4"><!-- Card -->
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Novo Funcionário</h6>
                                        </div>
                                        <div class="card-body">
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md control-label" for="lb_titulo">Nome do funcionário</label>  
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-12 p-3">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="btn btn-primary btn-block" id="btn_salvar_funci">Adicionar</div>
                                                                </div>
