<%-- 
    Document   : gerenciarTipoAtividade
    Created on : 23 de nov de 2019, 09:52:20
    Author     : Victor
--%>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Configurações para Tipo de Atividade</h1>
                                ...
                                <form class="form-horizontal" id="formid">
                                    ...
                                    <div class="card shadow mb-4"><!-- Card -->
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Tipo Atividade</h6>
                                        </div>
                                        <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 p-3">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="btn btn-primary btn-block" id="btn_salvar_tipo">Adicionar</div>
                                                                </div>
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="collapse show" id="cardEstBackLog">
                                                    <div class="card-body overflow-auto"  style="max-height: 19rem" >
                                                        <h3>Status de Atividades cadastrados</h3>
                                                        <hr/>
